...
begin
  try
    var s23 := Arr(
      ExprNode.FromStr('r.00*s13.x + r.01*s13.y + r.02*s13.z'),
      ExprNode.FromStr('r.10*s13.x + r.11*s13.y + r.12*s13.z'),
      ExprNode.FromStr('r.20*s13.x + r.21*s13.y + r.22*s13.z')
    );
    
    s23 := s23.ConvertAll(e->e
      .Println.PrintInsert
      
      .ReplaceVar('s13.x', 'x*cos(a) / sqrt(x*x+1)')
      .ReplaceVar('s13.y', 'x*sin(a) / sqrt(x*x+1)')
      .ReplaceVar('s13.z', '1 / sqrt(x*x+1)')
      .Println.PrintInsert
      ...
      .ReplaceVar('u.val0', 'x*cos(a) / (x*x+1)*2')
      .ReplaceVar('u.val1', 'x*sin(a) / (x*x+1)*2')
